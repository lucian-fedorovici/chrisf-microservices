...
public static class EndpointDefinitions
{
    public static void AddEndpoints(this WebApplication app)
    {
        ...
        // Todo: should we use different body for PUT, POST and GET
        // e.g. have CreateContactRequest, UpdateContactRequest?
        app.MapPost("/contact", PostContact)
            .DocumentPostRequest<ContactRecord>("Contact", "PostContact", "Creates a contact");

        // Todo: if we have both PUT and POST, should we have id in the route for PUT?
